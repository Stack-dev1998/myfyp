...
export default class CreateProfile extends React.Component {
  ...
  render() {
    var userInfo = this.props.user.needyPerson;
    return (
      <div>
        <Modal
          {...this.props}
        ...
        >
          <Modal.Header closeButton>
            <h5 style={{ color: "black" }}>Update Profile Menu</h5>
          </Modal.Header>
          <Modal.Body>
            ...
            <Formik
              ...
              onSubmit={(values) => {
                ...
                axios({
                  method: "post",
                  url: "http://localhost:5000/needy-person/update-profile",
                  data: values,
                  headers: {
