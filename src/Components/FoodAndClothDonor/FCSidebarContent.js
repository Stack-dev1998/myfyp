...
class FCDSidebarContent extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div style={{ margin: "none" }}>
        ...
        <div style={{ display: "inline-flex" }} className=" mt-2 pl-4">
          <MdAddCircleOutline style={{ fontSize: "23px", color: " #1F618D" }} />
          <Nav.Link
            style={{
              lineHeight: "2px",
              fontSize: " 0.9rem",
        ...
        <div style={{ display: "inline-flex" }} className=" mt-4 pl-4">
          <FaListUl style={{ fontSize: "19px", color: " #1F618D" }} />
          <Nav.Link
            style={{
              lineHeight: "2px",
              fontSize: " 0.9rem",
        ...
        <div style={{ display: "inline-flex" }} className=" mt-4 pl-4">
          ...
          <Nav.Link
            ...
            as={Link}
            className="mt-1  "
            to="/fc-donor/add-cloth"
          >
            ADD CLOTH
          </Nav.Link>
        </div>
        <div style={{ display: "inline-flex" }} className=" mt-4 pl-4">
          <FaListUl style={{ fontSize: "22px", color: " #1F618D" }} />
          <Nav.Link
            style={{
              lineHeight: "2px",
              fontSize: " 0.9rem",
        ...
        >
          ...
          <p
            onClick={() => {
              cookies.remove("food and cloth donor");
...
export default withRouter(FCDSidebarContent);
