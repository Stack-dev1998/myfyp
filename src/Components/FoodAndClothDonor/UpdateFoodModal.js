...
export default function UpdateFoodModal(props) {
  let data = props.data;
  ...
  const onSubmitHandler = (e) => {
    e.preventDefault();
    axios("http://localhost:5000/fc-donor/update-food", {
      method: "post",
      data: { food: updateData },
      headers: {
              ...
              <Form.Row>
                <Col>
                  ...
                  <Form.Control
                    ...
                    type="time"
                    onChange={onChangeHandler}
                    defaultValue={updateData.durationFrom}
                  />
                </Col>
              </Form.Row>
              <Form.Row>
                <Col>
                  ...
                  <Form.Control
                    ...
                    type="time"
                    onChange={onChangeHandler}
                    defaultValue={updateData.durationTo}
                  />
                </Col>
              </Form.Row>
